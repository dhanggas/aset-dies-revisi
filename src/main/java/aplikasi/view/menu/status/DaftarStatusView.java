 ...
 * @author dhiskar
 */
public class DaftarStatusView extends javax.swing.JInternalFrame {

    private List<StatusAset> daftarAset;
    private final RepoStatusAset repo;
     ...
     */
    public DaftarStatusView(MainMenuView menuController) {
        initComponents();
        this.menuController = menuController;
        this.repo = new ServiceStatusAset(KoneksiDB.getDataSource());
    ...
    public void refreshDataTable() {
        try {
            ...
            daftarAset = repo.findAll();
            for (StatusAset k : daftarAset) {
                Object[] row = {k.getId(), k.getStatus()};
    ...
    public void refreshDataTableByName() {
        try {
            this.tableController.clearData();
            daftarAset = repo.findByNama(txtCari.getText());
            for (StatusAset k : daftarAset) {
                Object[] row = {k.getId(), k.getStatus()};
                tableController.getModel().addRow(row);
            }
    ...
    private void initComponents() {
        ...
        txtNamaStatus = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Daftar Status"));

        txtCari.setToolTipText("Pencarian berdasarkan nama status");
        ...
        jLabel13.setText("Nama Status");

        txtKode.setEditable(false);

        txtNamaStatus.setEditable(false);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNamaStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtNamaStatus, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        if (tableController.isSelected()) {
            StatusAset stAset = daftarAset.get(tableController.getRowSelected());
            int jawab = JOptionPane.showOptionDialog(this, "Ingin Menghaspus data dengan kode " + stAset.getId() + " ?", getTitle(), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
            if (jawab == JOptionPane.YES_OPTION) {
                try {
                    repo.delete(stAset.getId());
                    refreshDataTableByName();
                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(this, "Tidak dapat menghapus data status", getTitle(), JOptionPane.ERROR_MESSAGE);
                    Logger.getLogger(DaftarStatusView.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        } else {
            JOptionPane.showMessageDialog(this, "Data kategori status belum pilih", getTitle(), JOptionPane.WARNING_MESSAGE);
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        if (tableController.isSelected()) {
            StatusAset statusAset = daftarAset.get(tableController.getRowSelected());
            DataStatusAsetView view = new DataStatusAsetView(menuController, this, statusAset, true);
            view.setLocationRelativeTo(null);
            view.setResizable(false);
            view.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Data status belum dipilih!", getTitle(), JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_btnUbahActionPerformed

    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        DataStatusAsetView view = new DataStatusAsetView(menuController, this, true);
        view.setResizable(false);
        view.setLocationRelativeTo(null);
        view.setVisible(true);
...
//        tableController.getSorter().setRowFilter(RowFilter.regexFilter(txtCari.getText()));
    ...
    private javax.swing.JTextField txtNamaStatus;
    // End of variables declaration//GEN-END:variables

    public void setFiels(StatusAset statusAset) {
        txtKode.setText(statusAset.getId().toString());
        txtNamaStatus.setText(statusAset.getStatus());
    }

    private void clearFields() {
        txtKode.setText("");
        txtNamaStatus.setText("");
    }
